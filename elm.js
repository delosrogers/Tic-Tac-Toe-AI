...
var $author$project$Types$NoOne = {$: 'NoOne'};
var $elm$core$Maybe$Nothing = {$: 'Nothing'};
var $author$project$Types$PlayerO = {$: 'PlayerO'};
var $author$project$Types$PlayerX = {$: 'PlayerX'};
...
var $author$project$GameLogic$generateChildIdxArray = F3(
	...
	function (list, lastBool, lastElement) {
		...
		while (true) {
			if (!list.b) {
				...
				var xs = list.b;
				var $temp$list = xs,
					$temp$lastBool = lastBool && (_Utils_eq(lastElement, x) && (!_Utils_eq(x, $author$project$Types$NoOne))),
					$temp$lastElement = x;
				list = $temp$list;
				lastBool = $temp$lastBool;
				lastElement = $temp$lastElement;
				continue equalAll;
			}
		}
	});
...
var $author$project$GameLogic$nextPlayer = function (player) {
	switch (player.$) {
		case 'PlayerO':
			return $author$project$Types$PlayerX;
		case 'PlayerX':
			return $author$project$Types$PlayerO;
		default:
		...
		switch (msg.$) {
			case 'MouseClick':
				...
				return A3(
					...
					(($elm$core$Basics$round(x) / ((500 / numRows) | 0)) | 0) + (numRows * (($elm$core$Basics$round(y) / ((500 / numRows) | 0)) | 0)),
					model,
					false);
			case 'AIPlay':
